    ...
    public partial class Increate5 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitSchedules", x => x.VisitScheduleId);
                    table.ForeignKey(
                        name: "FK_VisitSchedules_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "AreaId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitSchedules_Distributors_DistributorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitSchedules_AreaId",
                table: "VisitSchedules",
                column: "AreaId");

            migrationBuilder.CreateIndex(
                name: "IX_VisitSchedules_DistributorId",
                table: "VisitSchedules",
